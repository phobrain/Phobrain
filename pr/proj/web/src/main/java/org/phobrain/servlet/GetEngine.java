...
//  GetEngine - first main/live 'brain' of Phobrain.
...
*/
    ...
    private GetEngine() {
        ...
        ServletData.get();  // init singleton
...
//System.out.println("VN " + viewNum + " order " + last.orderInSession);
    ...
    private void handleUser2(Connection conn,
        ...
        for (Map.Entry<Long, List<String>> pair : fallback.entrySet()) {
            List<String> l = MiscUtil.objectToListString(pair.getValue());
            id_l.addAll(l);
        }
        if (bak_id_l != null) {
            bak_id_l.clear();
    ...
    private List<Screen> OLDhandleColorScreens(Connection conn,
        ...
        for (String column : try_col) {
            ...
            for (String id2 : lh.id2_l) {
                ...
                depth = MiscUtil.lossyMult(depth, 1.25); // MAGIC
            }
            ...
            len = MiscUtil.lossyMult(len, 1.25); // MAGIC
        }
...
//fast=true;
        ...
        switch (up.lastCrossings) {
            ...
            case 1:  // drop thru from 0 [lint ok]
            case 2:
    ...
    public List<Screen> getScreens(Connection conn,
        ...
        switch (option) {
          ...
          case 12:
            ...
            log.info("case 12 not used? replaced in-memory kwd-based join");
            break;
...
x++;
    ...
    private double[] higDim(List<HistoryPair> history) {
        ...
        for (int i=history.size()-1;i>-1;i-=1) {  // put in sequential order
            ...
            userTimes.add((double) sp.userTime);
            netTimes.add((double)  sp.bigTime);
                                      // -1,-2 ok
